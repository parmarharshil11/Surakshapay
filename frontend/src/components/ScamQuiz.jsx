          ...
          <div ref={explanationRef} className="p-5 bg-slate-50 dark:bg-slate-950/50 border border-slate-200 dark:border-slate-800 rounded-2xl space-y-3 animate-fade-in relative">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                disabled={ttsLoading}
                className={`ml-auto p-1.5 rounded-lg transition-all border border-slate-200/50 dark:border-slate-700/50 ${
                  ttsLoading
                ...
                title={
                  ttsLoading
                    ...
                    : (language === 'hi' ? 'विवरण सुनें' : language === 'gu' ? 'સ્પષ્ટીકરણ સાંભળો' : 'Read explanation aloud')
                }
              >
                {ttsLoading ? (
