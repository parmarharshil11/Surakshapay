    ...
    <div className="space-y-6 animate-fade-in max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
        ...
        <div className="md:col-span-7 bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-4 transition-colors duration-300">
          ...
          <div className="flex flex-wrap items-center justify-between gap-y-3 pt-3 border-t border-slate-100 dark:border-slate-800 mt-2">
              ...
              >
                {loading ? (
                  <>
                    ...
                    {language === 'en' ? 'Analyzing...' : language === 'hi' ? 'जांच...' : 'તપાસ...'}
                  </>
                ) : (
                  <>
              ...
              <div className="flex items-center gap-4 py-2">
                ...
                <div className="flex-1 space-y-1">
                  ...
                  <div className="text-xs font-semibold text-slate-500 dark:text-slate-400">
                    {t.smsConfidence}: <span className="text-slate-700 dark:text-slate-300">{result.score}%</span>
                  </div>
                </div>
              </div>
